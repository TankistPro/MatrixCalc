...
from UI_PY.devMatrix import Ui_Dialog

class matrixDev(QtWidgets.QDialog, Ui_Dialog):
    def __init__(self, parent=None, height=None, width=None):
        super(matrixDev, self).__init__(parent)
        ...
        self.pushButton.clicked.connect(self.devMatrix)

    def initUI(self):
        self.setWindowTitle("Вычитание")
